class FriendLinksController < AdminController
  before_action :set_friend_link, only: %i[ show edit update destroy ]
  ...
  def create
    ...
    respond_to do |format|
      if @friend_link.save
        format.html { redirect_to friend_link_url(@friend_link), notice: "Friend link was successfully created." }
  ...
  def update
    respond_to do |format|
      if @friend_link.update(friend_link_params)
        format.html { redirect_to friend_link_url(@friend_link), notice: "Friend link was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to friend_links_url, notice: "Friend link was successfully destroyed." }
