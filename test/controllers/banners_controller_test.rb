...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference("Banner.count") do
      post banners_url, params: { banner: { image: @banner.image, sorting: @banner.sorting, url: @banner.url } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { image: @banner.image, sorting: @banner.sorting, url: @banner.url } }
