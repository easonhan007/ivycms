...
class NavigationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create navigation" do
    assert_difference("Navigation.count") do
      post navigations_url, params: { navigation: { dropdown: @navigation.dropdown, link: @navigation.link, name: @navigation.name, sorting: @navigation.sorting } }
    end
  ...
  test "should update navigation" do
    patch navigation_url(@navigation), params: { navigation: { dropdown: @navigation.dropdown, link: @navigation.link, name: @navigation.name, sorting: @navigation.sorting } }
